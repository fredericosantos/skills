...
- **[just-init](skills/just-init/)** - Navigate and document Python packages using `__init__.py` docstrings as living indexes: read them before exploring, update them after every file change.
